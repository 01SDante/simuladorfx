...
public class RRFijasFirstFit1ES {
	...
	public static void ejecutar(ObservableList<ElementoTablaParticion> tablaParticiones,
		...
		System.out.println("RR 1E/S con quantum =  " + quantum + " - Particiones Fijas - FirstFit\n");
		...
		while (t <= tIrrupcion + tOcioso) {
			...
			if (!ejecutandoCpu.isEmpty()) {
				ejecutarCPU(particiones, procesos, ejecutandoCpu, ejecutandoEs, tablaProcesos, t, quantum);
			}
	...
	private static void ejecutarCPU(ArrayList<Particion> particiones, ArrayList<Proceso> procesos,
			...
			ObservableList<ElementoTablaProceso> tablaProcesos, int t, int quantum) {
