...
public class ProcesoAlgoritmo implements Comparable<ProcesoAlgoritmo> {
	int id;
	int tamanio;
	int cpu1;
	int es;
	...
	public ProcesoAlgoritmo(int id, int tamanio, int cpu1, int es, int cpu2, int tArribo) {
		this.id = id;
	...
	@Override
	public int compareTo(ProcesoAlgoritmo o) {
